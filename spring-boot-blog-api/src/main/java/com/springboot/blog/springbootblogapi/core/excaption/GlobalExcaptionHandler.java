...
import com.springboot.blog.springbootblogapi.core.entity.ErrorDetails;
...
public class GlobalExcaptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(BlogAPIExcaption.class)
	public ResponseEntity<ErrorDetails> handleBlogAPIExcaption(BlogAPIExcaption excaption, WebRequest webRequest) {
		ErrorDetails errorDetails = new ErrorDetails(new Date(), excaption.getMessage(),
				webRequest.getDescription(false));
